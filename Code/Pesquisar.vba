...
Private Sub lstCadastro_DblClick(Cancel As Integer)
    ...
    If strTabela = "Pedidos" Then
        DoCmd.OpenForm "Pedidos", , , "[codPedido] = " & Form_Pesquisar.lstCadastro.Value
        Form_Pedidos.AllowEdits = False
        Form_Pedidos.Caption = "Visualização do pedido!!!"
        Form_Pedidos.cmdSalvar.Enabled = False
        Form_ItensDosPedidos.AllowEdits = False
    Else
        cmdAlterar_Click
    End If
